...
from django.db.models import Avg, F, Q, Subquery, Count
...
from share.models import Share, ShareFile, ShareReview, ShareLike
...
class ShareDetailView(View):
    def get(self, request, id):
        ...
        university_member = University.objects.get(id=post.university_id)
        post_list = Share.enabled_objects.filter(university_id=university_member.id).order_by('-id')
